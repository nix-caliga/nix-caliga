...
#   removed openssh.authorizedKeys and security.googleOsLogin from lockout assertion
{
  config,
  lib,
  pkgs,
          ...
          assertion =
            ...
            -> any id (
              mapAttrsToList (
                ...
                && (
                  allowsLogin cfg.hashedPassword || cfg.password != null || cfg.hashedPasswordFile != null
                  # nix-caliga: openssh.authorizedKeys not available
                  # || cfg.openssh.authorizedKeys.keys != [ ]
                  # || cfg.openssh.authorizedKeys.keyFiles != [ ]
                )
              ) cfg.users
              # nix-caliga: security.googleOsLogin not available
              # ++ [
