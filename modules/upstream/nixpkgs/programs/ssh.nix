# copied from system-manager's nix/modules/upstream/nixpkgs/programs/ssh.nix
# changes:
#   environment.corePackages -> environment.systemPackages
#   removed environment.extraInit
#   "system-manager" -> "nix-caliga" in descriptions
####
...
in
{
    ...
    programs.ssh = {
      enable = lib.mkOption {
        ...
        description = ''
          ...
          When disabled, nix-caliga will not touch existing
  ...
  config = lib.mkIf cfg.enable {
    ...
    # nix-caliga: environment.corePackages -> environment.systemPackages
