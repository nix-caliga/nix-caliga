# copied from system-manager's nix/modules/systemd.nix
# changes:
#   removed system-manager.target and sysinit-reactivation targets
#   removed environment.etc output (handled by systemd/default.nix)
{
  lib,
  config,
  pkgs,
